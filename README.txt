...
There are two entities corresponding to a course and a assignments.
These are defined in assign.domain package. There is a foreign key relationship
between assignments entity and course entity. This relationship is expressed in
the assignments entity using @ManyToOne and @JoinColumn
